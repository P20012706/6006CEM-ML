...
print(f"Decision Tree Regression (After Feature Engineering) - Mean Squared Error: {mse}")
print(f"Decision Tree Regression (After Feature Engineering) - R-squared: {r2}")
